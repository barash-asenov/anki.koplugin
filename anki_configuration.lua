...
local Configuration = {
    ...
    Setting:new({ id = "primary_audio_source", default = "forvo" }),
    Setting:new({ id = "fallback_audio_source", default = "" }),
...
function Configuration:load_profile(profile_name)
    ...
    local main_profile, default_profile =
        assert(self.profiles[profile_name], ("Non existing profile %s!"):format(profile_name)), self.profiles["default"]
    local missing = {}
